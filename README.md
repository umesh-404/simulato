...
5. During the run:
   - For each question it captures, preprocesses, stitches frames if scrolling was needed, and **always sends the composite image directly to the cloud AI** (Grok/Gemini).
